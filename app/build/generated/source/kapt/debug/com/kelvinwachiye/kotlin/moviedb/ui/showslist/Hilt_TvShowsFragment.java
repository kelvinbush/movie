...
public abstract class Hilt_TvShowsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TvShowsFragment() {
    super();
  }

  Hilt_TvShowsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TvShowsFragment_GeneratedInjector) this.generatedComponent()).injectTvShowsFragment(UnsafeCasts.<TvShowsFragment>unsafeCast(this));
    }
  }
