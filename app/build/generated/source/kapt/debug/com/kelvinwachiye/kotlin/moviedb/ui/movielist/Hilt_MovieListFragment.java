...
public abstract class Hilt_MovieListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MovieListFragment() {
    super();
  }

  Hilt_MovieListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MovieListFragment_GeneratedInjector) this.generatedComponent()).injectMovieListFragment(UnsafeCasts.<MovieListFragment>unsafeCast(this));
    }
  }
