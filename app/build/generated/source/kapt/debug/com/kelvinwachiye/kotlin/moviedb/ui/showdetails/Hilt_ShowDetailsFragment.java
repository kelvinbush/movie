...
public abstract class Hilt_ShowDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShowDetailsFragment() {
    super();
  }

  Hilt_ShowDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShowDetailsFragment_GeneratedInjector) this.generatedComponent()).injectShowDetailsFragment(UnsafeCasts.<ShowDetailsFragment>unsafeCast(this));
    }
  }
